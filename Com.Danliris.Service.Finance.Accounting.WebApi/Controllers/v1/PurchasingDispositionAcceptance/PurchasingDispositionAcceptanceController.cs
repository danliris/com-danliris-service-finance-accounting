    ...
    public class PurchasingDispositionAcceptanceController : Controller
    {
        ...
        public async Task<ActionResult> Post([FromBody] PurchasingDispositionAcceptanceViewModel viewModel)
        {
            ...
            catch (AggregateException ex)
            {
                ...
                Dictionary<string, object> Result =
                    new ResultFormatter(ApiVersion, General.INTERNAL_ERROR_STATUS_CODE, message + APIEndpoint.Purchasing + ex)
                    .Fail();
            ...
            {
                Dictionary<string, object> Result =
                    new ResultFormatter(ApiVersion, General.INTERNAL_ERROR_STATUS_CODE, e.Message + APIEndpoint.Purchasing + e)
                    .Fail();
                return StatusCode(General.INTERNAL_ERROR_STATUS_CODE, Result);
            }
        }
