...
namespace Com.Danliris.Service.Finance.Accounting.Lib
{
    public interface IVbWithPORequestService
    {
        ...
        ReadResponse<VbRequestWIthPOList> ReadWithDateFilter(DateTime? dateFilter, int offSet, int page, int size, string order, List<string> select, string keyword, string filter);
