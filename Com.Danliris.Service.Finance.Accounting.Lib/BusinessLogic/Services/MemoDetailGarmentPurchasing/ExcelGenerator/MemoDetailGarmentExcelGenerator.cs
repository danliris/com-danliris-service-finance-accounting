...
namespace Com.Danliris.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoDetailGarmentPurchasing.ExcelGenerator
{
    public static class MemoDetailGarmentExcelGenerator
    {
        ...
        private static void SetData(ExcelWorksheet worksheet, ReadResponse<ReportRincian> data, int month, int year)
        {
            ...
            worksheet.Cells["G4"].Value = "Keterangan";
            worksheet.Cells["G4"].Style.Font.Size = 14;
            worksheet.Cells["H4"].Value = "Kurs";
            worksheet.Cells["H4"].Style.Font.Size = 14;
            worksheet.Cells["I4"].Value = "Kurs Pembayaran";
            worksheet.Cells["I4"].Style.Font.Size = 14;
            worksheet.Cells["J4"].Value = "Kurs Beli";
            worksheet.Cells["J4"].Style.Font.Size = 14;
            worksheet.Cells["K4"].Value = "Jumlah";
            worksheet.Cells["K4"].Style.Font.Size = 14;
            worksheet.Cells["L4"].Value = "Jumlah Dalam Rupiah";
            ...
            if (data.Data.Count > 0)
            {
                ...
                foreach (var item in data.Data)
                {
                    ...
                    worksheet.Cells[$"G{currentRow}"].Value = item.RemarksDetail;
                    worksheet.Cells[$"G{currentRow}"].Style.Font.Size = 14;
                    worksheet.Cells[$"H{currentRow}"].Value = item.CurrencyCode;
                    worksheet.Cells[$"H{currentRow}"].Style.Font.Size = 14;
                    worksheet.Cells[$"I{currentRow}"].Value = item.PaymentRate;
                    ...
                    worksheet.Cells[$"J{currentRow}"].Value = item.PurchasingRate;
                    ...
                    worksheet.Cells[$"K{currentRow}"].Value = item.MemoAmount.ToString("N2");
                    ...
                    worksheet.Cells[$"L{currentRow}"].Value = item.MemoIdrAmount.ToString("N2");
                ...
                worksheet.Cells[$"A4:L{currentRow - 1}"].AutoFitColumns();
                worksheet.Cells[$"A4:L{currentRow - 1}"].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[$"A4:L{currentRow - 1}"].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[$"A4:L{currentRow - 1}"].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[$"A4:L{currentRow - 1}"].Style.Border.Left.Style = ExcelBorderStyle.Thin;
            }
            else
            {
            }
