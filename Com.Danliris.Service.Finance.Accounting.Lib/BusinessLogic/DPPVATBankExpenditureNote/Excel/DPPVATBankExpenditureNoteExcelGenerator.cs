    ...
    public class DPPVATBankExpenditureNoteExcelGenerator
    {
        ...
        private static void SetData(ExcelWorksheet worksheet, List<ReportDto> data, int timezoneOffset)
        {
            ...
            foreach (var datum in data)
            {
                ...
                worksheet.Cells[$"D{currentRow}"].Value = datum.BankCashNo;
                worksheet.Cells[$"D{currentRow}"].Style.Font.Size = 14;
                worksheet.Cells[$"D{currentRow}:D{currentRow + indexDo}"].Merge = true;

                worksheet.Cells[$"E{currentRow}"].Value = (datum.Amount* datum.CurrencyRate).ToString("N2", cultureInfo);
                ...
                {
                    worksheet.Cells[$"F{currentRow}"].Value = datum.Amount.ToString("N2", cultureInfo);
                ...
                {
                    worksheet.Cells[$"F{currentRow}"].Value = 0.0.ToString("N2", cultureInfo);
                    worksheet.Cells[$"F{currentRow}"].Style.Font.Size = 14;
                    worksheet.Cells[$"F{currentRow}"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
                    worksheet.Cells[$"F{currentRow}:F{currentRow + indexDo}"].Merge = true;
                }

                worksheet.Cells[$"G{currentRow}"].Value = datum.CategoryName;
                worksheet.Cells[$"G{currentRow}"].Style.Font.Size = 14;
                worksheet.Cells[$"G{currentRow}:G{currentRow + indexDo}"].Merge = true;

                worksheet.Cells[$"H{currentRow}"].Value = datum.PaymentMethod;
                worksheet.Cells[$"H{currentRow}"].Style.Font.Size = 14;
                worksheet.Cells[$"H{currentRow}:H{currentRow + indexDo}"].Merge = true;

                worksheet.Cells[$"I{currentRow}"].Value = datum.InvoiceAmount.ToString("N2", cultureInfo);
                ...
                worksheet.Cells[$"J{currentRow}"].Value = (datum.InvoiceAmount * 0.1).ToString("N2", cultureInfo);
                ...
                worksheet.Cells[$"K{currentRow}"].Value = 0.0;
                worksheet.Cells[$"K{currentRow}"].Style.Font.Size = 14;
                worksheet.Cells[$"K{currentRow}:K{currentRow + indexDo}"].Merge = true;

                worksheet.Cells[$"L{currentRow}"].Value = (datum.InvoiceAmount + (datum.InvoiceAmount * 0.1)).ToString("N2", cultureInfo);
                ...
                worksheet.Cells[$"T{currentRow}"].Value = datum.InvoiceAmount.ToString("N2", cultureInfo);
                worksheet.Cells[$"T{currentRow}"].Style.Font.Size = 14;
                worksheet.Cells[$"T{currentRow}"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
                ...
                foreach (var dos in datum.DetailDO)
                {
                    ...
                    worksheet.Cells[$"AB{currentRow}"].Value = dos.CurrencyRate;
                    ...
                    worksheet.Cells[$"AD{currentRow}"].Value = (dos.TotalAmount * dos.CurrencyRate).ToString("N2", cultureInfo);
                    ...
                    worksheet.Cells[$"AE{currentRow}"].Value = (dos.TotalAmount - (dos.TotalAmount * dos.CurrencyRate)).ToString("N2", cultureInfo);
            ...
            worksheet.Cells[$"A6:AE{currentRow}"].AutoFitColumns();
            worksheet.Cells[$"A6:AE{currentRow}"].Style.Border.Top.Style = ExcelBorderStyle.Thin;
            worksheet.Cells[$"A6:AE{currentRow}"].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
            worksheet.Cells[$"A6:AE{currentRow}"].Style.Border.Left.Style = ExcelBorderStyle.Thin;
            worksheet.Cells[$"A6:AE{currentRow}"].Style.Border.Right.Style = ExcelBorderStyle.Thin;
        }
