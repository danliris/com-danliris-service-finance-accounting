    ...
    public partial class Add_MemoGarmentPurchasingDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "MemoGarmentPurchasingDetailModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemoGarmentPurchasingDetailModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemoGarmentPurchasingDetailModel_MemoGarmentPurchasings_MemoId",
                        column: x => x.MemoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemoGarmentPurchasingDetailModel_MemoId",
                table: "MemoGarmentPurchasingDetailModel",
                column: "MemoId");
        }
