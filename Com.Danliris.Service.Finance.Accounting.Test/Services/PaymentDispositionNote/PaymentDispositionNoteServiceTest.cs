...
namespace Com.Danliris.Service.Finance.Accounting.Test.Services.PaymentDispositionNote
{
    public class PaymentDispositionNoteServiceTest
    {
        ...
        public async Task Should_Success_Get_Report_Xls()
        {
            ...
            var xls = service.GetXls(new List<ReportDto>() { new ReportDto(1, "", DateTimeOffset.Now, 1, "", DateTimeOffset.Now, DateTimeOffset.Now, 1, "", 1, "", 1, "", false, "", 1, "", 1, "", 1, 1, "", "", 1, "", 1, 1) });
            var xls2 = service.GetXls(new List<ReportDto>() { new ReportDto(1, "", DateTimeOffset.Now, 1, "", DateTimeOffset.Now, DateTimeOffset.Now, 1, "", 1, "", 1, "", false, "", 1, "", 1, "", 1, 1, "", "", 0, "", 1, 1) });
