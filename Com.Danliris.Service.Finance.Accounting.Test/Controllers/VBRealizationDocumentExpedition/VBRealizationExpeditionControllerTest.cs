...
namespace Com.Danliris.Service.Finance.Accounting.Test.Controllers.VBRealizationDocumentExpedition
{
    public class VBRealizationExpeditionControllerTest
    {
        ...
        public async Task GetReport_Return_OK()
        {
            ...
            service
                .Setup(s => s.GetReports(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>()))
            ...
            //Act
            IActionResult response = await GetController(serviceProviderMock).GetReport(1,1,"",1,1,null,null,null, null, null, null, null, 25);
        ...
        public async Task GetReport_With_dateStart_and_dateEnd_Return_OK()
        {
            ...
            //Act
            IActionResult response = await GetController(serviceProviderMock).GetReport(1, 1, "", 1, 1,DateTime.Now, DateTime.Now.AddDays(2), DateTime.Now, DateTime.Now.AddDays(2), DateTime.Now, DateTime.Now.AddDays(2), null, 25);
        ...
        public async Task GetReport_Return_InternalServerError()
        {
            ...
            service.Setup(s => s.GetReports(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>())).ThrowsAsync(new Exception());
        ...
        public async Task GetReportXls_Return_OK()
        {
            ...
            IActionResult response = await GetController(serviceProviderMock).GetReportXls(1, 1, "", 1, 1, null, null, null, null, null, null, null);
            Assert.Equal("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", response.GetType().GetProperty("ContentType").GetValue(response, null));

            IActionResult response2 = await GetController(serviceProviderMock).GetReportXls(1, 1, "", 1, 1, DateTime.UtcNow.AddDays(-30), DateTime.UtcNow, DateTime.UtcNow.AddDays(-30), DateTime.UtcNow, DateTime.UtcNow.AddDays(-30), DateTime.UtcNow, null);
