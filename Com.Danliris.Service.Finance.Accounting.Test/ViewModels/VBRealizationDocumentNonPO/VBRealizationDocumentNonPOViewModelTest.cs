...
namespace Com.Danliris.Service.Finance.Accounting.Test.ViewModels.VBRealizationDocumentNonPO
{
    public class VBRealizationDocumentNonPOViewModelTest
    {
        ...
        //    Mock<FinanceDbContext> financeGarmentDbContextMock = new Mock<FinanceDbContext>();
        //    //financeGarmentDbContextMock.Setup(s => s.Read(It.IsAny<int>(), It.IsAny<string>()))
        //    serviceProvider.Setup(s => s.GetService(typeof(FinanceDbContext))).Returns(new VBRealizationDocumentNonPO());
